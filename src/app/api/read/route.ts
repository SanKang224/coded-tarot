...
해석 다음 줄에 반드시 결론: 으로 시작하는 한 줄을 출력하라.

▸ 질문이 명확히 YES/NO로 답할 수 있는 경우
  ("~가 나를 좋아하는가", "~를 해야 하는가", "~이 가능한가" 등 이진 판단):
  결론: 예  또는  결론: 아니오  또는  결론: 알 수 없다 (셋 중 하나)
  선택지 비교라면: 결론: A가 낫다 / 결론: B가 낫다

▸ 질문이 YES/NO로 답할 수 없는 경우
  (상황, 감정, 경험, 기간의 분위기 등 — 예: "이번 주말 어떨까", "이 상황이 어떻게 될까"):
  결론: [이 상황의 결말을 단정짓는 날카로운 한 문장]
  예시: "이번 주말은 기대와 다른 얼굴로 기억될 것이다."
        "그 감정은 소진되기 전에 행동으로 옮겨지지 않을 것이다."

결론 줄을 생략하거나 두 줄 이상 쓰지 마라.`
    : '';
